project "CEF"
	...
	postbuildcommands {
		"{COPY} \""..cef_path.."Release/*\" \""..path.."GninE\"",
		"{COPY} \""..cef_path.."Resources/icudtl.dat\" \""..path.."GninE\"",
		"{COPY} \""..cef_path.."Resources/*.pak\" \""..path.."GninE/cef\"",
		"{COPY} \""..cef_path.."Resources/locales/*\" \""..path.."GninE/cef/locales\""
	}
