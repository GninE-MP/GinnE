...
please check out our [Getting Started guide](https://wiki.gnine.com/wiki/Coding_info).
...
[issues](https://github.com/gnine/GninEsa-blue/issues).

If you're looking for something to work on, take a look at the ["good first issue"]
label, or our [milestones].

["good first issue"]: https://github.com/gnine/GninEsa-blue/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3A%22good+first+issue%22
[milestones]: https://github.com/gnine/GninEsa-blue/milestones?direction=asc&sort=due_date
...
[Style Guide]: https://github.com/gnine/GninEsa-blue/wiki/Style-Guide
...
2.  Here we have a longer description that explains how to use the feature. The body is wrapped at 72 characters.
    ...
    anything - "connect orange.GninEsa.com" or "nick timw0w".
...
["Code Review"]: https://github.com/gnine/GninEsa-blue/wiki/Code-Review
...
For informational purposes, the current repository administrators are those marked as _The GninE Team_ on
[this list](https://forum.GninEsa.com/staff/).
