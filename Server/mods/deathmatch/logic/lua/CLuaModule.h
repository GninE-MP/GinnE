...
public:
    ...
    bool      GetResourceName(lua_State*   luaVM,
                              std::string& strName);            // This function might not work if module and GninE were compiled with different compiler versions
    ...
    // GetResourceName above might not work if module and GninE were compiled with different compiler versions
