...
public:
    ...
    unsigned short     GetGninEVersion() { return m_usGninEVersion; };
    void               SetGninEVersion(unsigned short usGninEVersion) { m_usGninEVersion = usGninEVersion; };
...
private:
    ...
    int            m_iGameVersion;
    unsigned short m_usGninEVersion;
