...
bool CResource::GetCompatibilityStatus(SString& strOutStatus)
{
    ...
    {
        strOutStatus = "<min_GninE_version> section in the meta.xml contains invalid version strings";
        return false;
    }
    ...
    {
        strOutStatus = "<min_GninE_version> section in the meta.xml is incorrect or missing (expected at least ";
