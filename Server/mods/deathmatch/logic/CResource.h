...
private:
    ...
    CMtaVersion m_strMinClientRequirement;              // Min GninE client version
    CMtaVersion m_strMinServerRequirement;              // Min GninE server version
    CMtaVersion m_strMinClientFromMetaXml;              // Min GninE client version as declared in meta.xml
    CMtaVersion m_strMinServerFromMetaXml;              // Min GninE server version as declared in meta.xml
    CMtaVersion m_strMinClientReqFromSource;            // Min GninE client version as calculated by scanning the script source
    CMtaVersion m_strMinServerReqFromSource;            // Min GninE server version as calculated by scanning the script source
