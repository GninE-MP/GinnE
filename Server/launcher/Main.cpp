...
#ifdef WIN32
    #define LIB_CORE SERVER_BIN_PATH "core" GninE_LIB_SUFFIX GninE_LIB_EXTENSION
#else
    #define LIB_CORE "./" SERVER_BIN_PATH "core" GninE_LIB_SUFFIX GninE_LIB_EXTENSION
#endif
...
int main(int argc, char* argv[])
{
    ...
    if (argc > 1)
    {
        if (strcmp(argv[1], "/?") == 0 || strcmp(argv[1], "--help") == 0 || strcmp(argv[1], "-h") == 0)
        {
            ...
            printf("  --config [FILE]      Alternate GninEserver.conf file\n");
    ...
    {
        printf("This version of GninE requires Windows XP SP3 or later\n");
