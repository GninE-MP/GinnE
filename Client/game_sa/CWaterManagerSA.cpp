...
// pool; however in GninE, we can dynamically delete water polys,
...
void CWaterManagerSA::GetZonesIntersecting(const CVector& startPos, const CVector& endPos, std::vector<CWaterZoneSA*>& vecOut)
{
    ...
    for (; n > 0; --n)
    {
        // A bound check here fixes client crash (https://github.com/gnine/GninEsa-blue/issues/835)
        // See PR https://github.com/gnine/GninEsa-blue/pull/836
