                                              ...
                                              CefRefPtr<CefRequest> request)
{
    ...
    if (scheme_name == "http" && host == "GninE")
    {
        // Scheme format: http://GninE/resourceName/file.html or http://GninE/local/file.html for the current resource
