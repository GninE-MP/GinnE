...
#define CGUI_GninE_DEFAULT_FONT       "tahoma.ttf"        // %WINDIR%/font/<...>
#define CGUI_GninE_DEFAULT_FONT_BOLD  "tahomabd.ttf"      // %WINDIR%/font/<...>
#define CGUI_GninE_CLEAR_FONT         "verdana.ttf"       // %WINDIR%/font/<...>

#define CGUI_GninE_DEFAULT_REG        "Tahoma (TrueType)"
#define CGUI_GninE_DEFAULT_REG_BOLD   "Tahoma Bold (TrueType)"
#define CGUI_GninE_CLEAR_REG          "Verdana (TrueType)"

#define CGUI_GninE_SUBSTITUTE_FONT    "cgui/unifont.ttf"  // GTA/GninE/<...>
#define CGUI_GninE_SANS_FONT          "cgui/sans.ttf"     // GTA/GninE/<...>
#define CGUI_SA_HEADER_FONT         "cgui/saheader.ttf" // GTA/GninE/<...>
#define CGUI_SA_GOTHIC_FONT         "cgui/sagothic.ttf" // GTA/GninE/<...>
#define CGUI_SA_HEADER_SIZE         26
#define CGUI_SA_GOTHIC_SIZE         47
#define CGUI_GninE_SANS_FONT_SIZE     9
...
CGUI_Impl::CGUI_Impl(IDirect3DDevice9* pDevice) : m_HasSchemeLoaded(false), m_fCurrentServerCursorAlpha(1.0f)
{
    ...
    */
    ...
    m_pSystem = new CEGUI::System(m_pRenderer, CEGUI::String(CalcGninESAPath(PathJoin("GninE", "logs", "CEGUI.log"))).data());
    ...
    SetDefaultGuiWorkingDirectory(CalcGninESAPath("GninE"));
    ...
    try
    {
        m_pUniFont = (CGUIFont_Impl*)CreateFnt("unifont", CGUI_GninE_SUBSTITUTE_FONT, 9, 0, false);
    ...
    // Window fonts first
    m_pDefaultFont = (CGUIFont_Impl*)CreateFntFromWinFont("default-normal", CGUI_GninE_DEFAULT_REG, CGUI_GninE_DEFAULT_FONT, 9, 0);
    m_pSmallFont = (CGUIFont_Impl*)CreateFntFromWinFont("default-small", CGUI_GninE_DEFAULT_REG, CGUI_GninE_DEFAULT_FONT, 7, 0);
    m_pBoldFont = (CGUIFont_Impl*)CreateFntFromWinFont("default-bold-small", CGUI_GninE_DEFAULT_REG_BOLD, CGUI_GninE_DEFAULT_FONT_BOLD, 8, 0);
    m_pClearFont = (CGUIFont_Impl*)CreateFntFromWinFont("clear-normal", CGUI_GninE_CLEAR_REG, CGUI_GninE_CLEAR_FONT, 9);
    ...
    try
    {
        ...
        m_pSansFont = (CGUIFont_Impl*)CreateFnt("sans", CGUI_GninE_SANS_FONT, CGUI_GninE_SANS_FONT_SIZE, 0, false);
    }
    catch (CEGUI::InvalidRequestException e)
    {
        SString strMessage = e.getMessage().c_str();
...
void CGUI_Impl::SetSkin(const char* szName)
{
    ...
    PushGuiWorkingDirectory(CalcGninESAPath(PathJoin("skins", szName)));
...
CEGUI::Window* CGUI_Impl::GetMasterWindow(CEGUI::Window* wnd)
{
    ...
    // if there's no CEGUI userdata, we deduce that it's not an GninE gui element
    if (!wnd->getUserData())
    {
        CEGUI::Window* parent = wnd->getParent();
        // It was created by CEGUI, probably as a child widget.
        // So keep propogating upwards until we find an GninE element
        while (parent)
        {
