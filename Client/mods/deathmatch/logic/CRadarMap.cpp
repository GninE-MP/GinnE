...
CRadarMap::CRadarMap(CClientManager* pManager)
{
    ...
    m_pRadarImage =
        g_pCore->GetGraphics()->GetRenderItemManager()->CreateTexture(CalcGninESAPath("GninE\\cgui\\images\\radar.jpg"), NULL, false, 1024, 1024, RFORMAT_DXT1);
    m_pLocalPlayerBlip = g_pCore->GetGraphics()->GetRenderItemManager()->CreateTexture(CalcGninESAPath("GninE\\cgui\\images\\radarset\\02.png"));
...
void CRadarMap::CreateMarkerTextures()
{
    ...
    SString strRadarSetDirectory = CalcGninESAPath("GninE\\cgui\\images\\radarset\\");
