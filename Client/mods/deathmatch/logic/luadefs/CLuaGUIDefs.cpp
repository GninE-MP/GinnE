...
void CLuaGUIDefs::LoadFunctions()
{
    constexpr static const std::pair<const char*, lua_CFunction> functions[]{
        ...
        {"isGninEWindowActive", GUIIsGninEWindowActive},
...
void CLuaGUIDefs::AddGuiElementClass(lua_State* luaVM)
{
    ...
    lua_classfunction(luaVM, "isGninEWindowActive", "isGninEWindowActive");
    ...
    lua_classvariable(luaVM, "GninEWindowActive", NULL, "isGninEWindowActive");
...
int CLuaGUIDefs::GUIIsGninEWindowActive(lua_State* luaVM)
{
    bool bActive =
