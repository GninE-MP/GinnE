...
public:
    ...
    virtual void OnFocusedNodeChanged(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, CefRefPtr<CefDOMNode> node) override
    {
        if (m_bHasInputFocus)
        {
            ...
            // Tell GninE that we lost input focus
    ...
    virtual void OnContextCreated(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, CefRefPtr<CefV8Context> context) override
    {
        ...
        // Create GninE object
        CefRefPtr<CefV8Value> GninEObject = CefV8Value::CreateObject(nullptr, nullptr);

        // Bind V8 --> C++ functions
        V8Helpers::BindV8Function(handler, GninEObject, "triggerEvent", Javascript_triggerEvent);

        // Assign GninEObject to global object
        globalObject->SetValue("GninE", GninEObject, V8_PROPERTY_ATTRIBUTE_NONE);
    }
