...
#define CHAT_PRESETS_PATH             "GninE/config/chatboxpresets.xml"
...
protected:
    ...
    CGUILabel*     m_pLabelGninEVolumeValue;
    ...
    CGUIScrollBar* m_pAudioGninEVolume;
    ...
    CGUICheckBox*  m_pCheckBoxMuteGninE;
    ...
    bool OnGninEVolumeChanged(CGUIElement* pElement);
    ...
    bool OnGninEMuteMinimizedChanged(CGUIElement* pElement);
