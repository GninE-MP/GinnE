 ...
 *  PURPOSE:     Create and destroy tray icon for GninE
 *
...
#define TRAY_BALLOON_TITLE      L"Notification from GninE:SA server"
#define TRAY_ICON_TOOLTIP_TEXT  L"GninE: San Andreas"
