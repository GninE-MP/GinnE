...
#define CORE_GninE_NEWS_ITEMS         3
...
private:
    ...
    CGUILabel* m_pNewsItemLabels[CORE_GninE_NEWS_ITEMS];
    CGUILabel* m_pNewsItemShadowLabels[CORE_GninE_NEWS_ITEMS];
    CGUILabel* m_pNewsItemDateLabels[CORE_GninE_NEWS_ITEMS];
    CGUILabel* m_pNewsItemNEWLabels[CORE_GninE_NEWS_ITEMS];
