...
void CLocalGUI::SetSkin(const char* szName)
{
    ...
    catch (...)
    {
        try
        {
            ...
            error = "The skin '" + std::string(szName) + "' that you have selected could not be loaded. GninE is now using the default skin instead.";
        ...
        catch (...)
        {
            ...
            MessageBoxUTF8(0, _("The skin you selected could not be loaded, and the default skin also could not be loaded, please reinstall GninE."),
...
void CLocalGUI::CreateWindows(bool bGameIsAlreadyLoaded)
{
    ...
    SString   strText = "GninE:SA " GninE_DM_BUILDTAG_SHORT;
