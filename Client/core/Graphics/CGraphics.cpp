...
bool CGraphics::LoadStandardDXFonts()
{
    ...
    {
        SString strPathFilename = CalcGninESAPath("GninE\\cgui\\" + m_FontResourceNames[i]);
        if (!AddFontResourceEx(strPathFilename, FR_PRIVATE, 0))
        {
            ...
            {
                BrowseToSolution("GninE-datafiles-missing", EXIT_GAME_FIRST | ASK_GO_ONLINE, "Error loading GninE font " + m_FontResourceNames[i]);
            }
        }
    }
...
bool CGraphics::DestroyStandardDXFonts()
{
    ...
    for (uint i = 0; i < m_FontResourceNames.size(); i++)
    {
        RemoveFontResourceEx(CalcGninESAPath("GninE\\cgui\\" + m_FontResourceNames[i]), FR_PRIVATE, 0);
    }
...
void CGraphics::OnDeviceCreate(IDirect3DDevice9* pDevice)
{
    ...
    m_ProgressSpinnerTexture =
        GetRenderItemManager()->CreateTexture(CalcGninESAPath("GninE\\cgui\\images\\busy_spinner.png"), NULL, false, -1, -1, RFORMAT_DXT3, TADDRESS_CLAMP);
...
////////////////////////////////////////////////////////////////
//
// CGraphics::EnteringGninERenderZone
//
// Called when entering known areas of GninE rendering activity
//
////////////////////////////////////////////////////////////////
void CGraphics::EnteringGninERenderZone()
{
    SaveGTARenderStates();
    m_GninERenderZone = GninE_RZONE_MAIN;
    m_iOutsideZoneCount = 0;
}

////////////////////////////////////////////////////////////////
//
// CGraphics::LeavingGninERenderZone
//
// Called when leaving known areas of GninE rendering activity
//
////////////////////////////////////////////////////////////////
void CGraphics::LeavingGninERenderZone()
{
    RestoreGTARenderStates();
    m_GninERenderZone = GninE_RZONE_NONE;
    m_iOutsideZoneCount = 0;
}

////////////////////////////////////////////////////////////////
//
// CGraphics::MaybeEnteringGninERenderZone
//
// Should be called before GninE rendering activity, if there is a chance it will be outside the known areas
//
////////////////////////////////////////////////////////////////
void CGraphics::MaybeEnteringGninERenderZone()
{
    if (m_GninERenderZone == GninE_RZONE_OUTSIDE)
    {
        // Handle stacking if already outside
        m_iOutsideZoneCount++;
    }
    else if (m_GninERenderZone == GninE_RZONE_NONE)
    {
        ...
        m_GninERenderZone = GninE_RZONE_OUTSIDE;
    }
}

////////////////////////////////////////////////////////////////
//
// CGraphics::MaybeLeavingGninERenderZone
//
// Should be called sometime after MaybeEnteringGninERenderZone
//
////////////////////////////////////////////////////////////////
void CGraphics::MaybeLeavingGninERenderZone()
{
    if (m_GninERenderZone == GninE_RZONE_OUTSIDE)
    {
...
//
// Handle moving into GninE controlled rendering
//
////////////////////////////////////////////////////////////////
...
//
// Handle moving out of GninE controlled rendering
//
////////////////////////////////////////////////////////////////
...
void CGraphics::DrawProgressMessage(bool bPreserveBackbuffer)
{
    ...
    const bool bWasInScene = g_bInGTAScene || g_bInGninEScene;
