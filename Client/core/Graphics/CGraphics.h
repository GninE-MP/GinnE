...
public:
    ...
    // Transition between GTA and GninE controlled rendering
    virtual void EnteringGninERenderZone();
    virtual void LeavingGninERenderZone();
    virtual void MaybeEnteringGninERenderZone();
    virtual void MaybeLeavingGninERenderZone();
...
private:
    ...
    enum EGninERenderZone
    {
        GninE_RZONE_NONE,
        GninE_RZONE_MAIN,               // GninE rendering inside known areas.
        GninE_RZONE_OUTSIDE,            // GninE rendering outside known areas. i.e. During a keypress or GTA callback
    };

    EGninERenderZone                          m_GninERenderZone;
