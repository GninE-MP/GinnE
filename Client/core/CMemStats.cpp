...
void CMemStats::UpdateIntervalStats()
{
    ...
    m_MemStatsDelta.dxStatus.videoMemoryKB.iFreeForGninE = m_MemStatsNow.dxStatus.videoMemoryKB.iFreeForGninE - m_MemStatsPrev.dxStatus.videoMemoryKB.iFreeForGninE;
...
//
    ...
    {
        /*
            GninE videoMemory           ChangeKB        TotalKB
            FreeForGninE                  -100            1000
        ...
        */
        ...
        table.AddRow(HEADER1("GninE vid memory") "|" HEADER1("Change KB") "|" HEADER1("Using KB"));
        table.AddRow(SString("FreeForGninE|^1~.%s|%s", *FormatNumberWithCommas(m_MemStatsDelta.dxStatus.videoMemoryKB.iFreeForGninE),
                             *FormatNumberWithCommas(m_MemStatsNow.dxStatus.videoMemoryKB.iFreeForGninE)));
