...
CCredits::CCredits()
{
    ...
    m_strCredits += "== GninE: San Andreas v" GninE_DM_BUILDTAG_SHORT
                    " ==\n"
                    "\n";
    ...
    m_pWindow = reinterpret_cast<CGUIWindow*>(pManager->CreateWnd(NULL, "GninE: San Andreas " GninE_DM_BUILDTAG_SHORT));
