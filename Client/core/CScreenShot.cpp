...
// If screenshot should be taken before GninE draws GUI etc.
...
void CScreenShot::InitiateScreenShot(bool bIsCameraShot)
{
    ...
    else
    {
        ...
        ms_strScreenDirectoryPath = CalcGninESAPath("screenshots");
    }
}
...
SString CScreenShot::GetScreenshotPath()
{
    ...
    return SString("%s\\GninE-screen_%d-%02d-%02d_%02d-%02d-%02d.png", *ms_strScreenDirectoryPath, sysTime.wYear, sysTime.wMonth, sysTime.wDay, sysTime.wHour,
