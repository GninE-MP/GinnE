...
void CClientVariables::ValidateValues()
{
    ...
    ClampValue("GninEvolume", 0.0f, 1.0f);
...
void CClientVariables::LoadDefaults()
{
    ...
    DEFAULT("GninEvolume", 1.0f);                                                       // custom sound's volume
    ...
    DEFAULT("mute_GninE_when_minimized", 0);                                            // 0-off 1-on
    DEFAULT("mute_voice_when_minimized", 0);                                          // 0-off 1-on
    DEFAULT("share_file_cache", 1);                                                   // 0-no 1-share client resource file cache with other GninE installs
