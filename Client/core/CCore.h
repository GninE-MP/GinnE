...
#define BLUE_VERSION_STRING   "GninE v" GninE_DM_BUILDTAG_LONG
#define BLUE_COPYRIGHT_STRING "Copyright (C) 2003 - %BUILD_YEAR% GninE"

// Configuration file path (relative to GninE install directory)
#define GninE_CONFIG_PATH            "GninE/config/coreconfig.xml"
#define GninE_SERVER_CACHE_PATH      "GninE/config/servercache.xml"
#define GninE_CONSOLE_LOG_PATH       "GninE/logs/console.log"
#define GninE_CONSOLE_INPUT_LOG_PATH "GninE/logs/console-input.log"
