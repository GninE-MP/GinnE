...
public:
    ...
    virtual void EnteringGninERenderZone() = 0;
    virtual void LeavingGninERenderZone() = 0;
    virtual void MaybeEnteringGninERenderZone() = 0;
    virtual void MaybeLeavingGninERenderZone() = 0;
