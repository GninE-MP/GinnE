...
public:
    ...
    virtual bool GetResourceName(
        lua_State* luaVM, std::string& strName) = 0;            // This function might not work if module and GninE were compiled with different compiler versions
...
public:
    ...
    // GetResourceName above doesn't work if module and GninE were compiled with different compiler versions
