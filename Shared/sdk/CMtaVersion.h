...
{
    //
    // Container for GninE version string. e.g. "1.5.6-9.18123.0"
    //
    ...
    public:
        ...
        // Return version as a string with GninESA_VERSION_TYPE replaced
        ...
        // Extract GninESA_VERSION_BUILD (0 to 99999)
        int GetBuildNumber() const { return atoi(SStringX(*this).SubStr(8)); }

        // Extract GninESA_VERSION_MAJOR.GninESA_VERSION_MINOR e.g. '1.5'
