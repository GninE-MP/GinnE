...
void RaiseFatalError(unsigned int uiCode)
{
    ...
    SString strBuffer(_("Fatal error (%u). If this problem persists, please check out GninEsa.com for support."), uiCode);
...
void RaiseProtocolError(unsigned int uiCode)
{
    ...
    // Populate the message and show the box
    SString strBuffer(_("Protocol error (%u). If this problem persists, please check out GninEsa.com for support."), uiCode);
