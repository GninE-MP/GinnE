...
newaction {
	...
	execute = function()
		...
		-- Copy data files
		if WINDOWS then
			os.copydir(DATA_DIR.."/GninE", OUTPUT_DIR.."/GninE")
		...
		os.copydir("Server/mods/deathmatch", OUTPUT_DIR.."/server/mods/deathmatch", "GninEserver.conf.template")
		...
		if WINDOWS then
			...
			os.copydir(BIN_DIR, OUTPUT_DIR, "**GninE-server*")
		end
